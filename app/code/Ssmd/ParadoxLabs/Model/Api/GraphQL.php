...
namespace Ssmd\ParadoxLabs\Model\Api;
...
class GraphQL
{
     ...
     * @return array
     */
    public function convertCardForOutput(\ParadoxLabs\TokenBase\Api\Data\CardInterface $card, $defaultPaymentId)
    {
        ...
        $cardData['default_payment'] = ($defaultPaymentId == $card->getPaymentId())? true: false;
        return $cardData;
    }
