...
class Data extends AbstractHelper
{
    ...
    public function orderReport($key, $value)
    {
       // ini_set('memory_limit', '3000M');
        ...
        $this->createCsvForOrderReport($collection,$countCollection, $createdDate,$downloadReportId, $adminName, $adminEmail);

    }
    public function createCsvForOrderReport($collection,$countCollection, $createdDate, $downloadReportId, $adminName, $adminEmail)
    {
        try{
            ...
            $filepath = 'exportcsv/order_report_' .$date. '.csv'; // at Directory path Create a Folder Export and FIle
            
            /*
            if(!file_exists('/var/www/html/ssmd/var/'.$filepath))
            {
                //echo '/var/www/html/ssmd/var/'.$filepath; exit;
                //echo "not exist";
