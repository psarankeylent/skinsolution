...
class BatchTransDataProvider extends \Magento\Framework\View\Element\UiComponent\DataProvider\DataProvider
{
    /**
     * Data Provider name
     *
    ...
    public function __construct(
        ...
        \CustomReports\BatchListReport\Model\ResourceModel\TransactionList\CollectionFactory $collectionFactory,
        array $meta = [],
        array $data = []
    ) {
        parent::__construct(
