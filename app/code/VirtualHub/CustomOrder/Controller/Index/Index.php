...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $order      = $this->orderFactory->create()->load(1442704);

        $request['order_consult_type']    = 'SF';
        echo $request['magento_order_id']      = $order->getIncrementId();
        echo "<br>";
        ...
        foreach ($order->getAllItems() as $item){
            ...
            if($product->getPrescription()){
                ...
                $tmpPrescriptionCount = $prescriptionCount;
        ...
        echo "tmpSkuCount ".$tmpSkuCount;
        echo "<br>";
        echo "tmpPrescriptionCount ".$tmpPrescriptionCount;


        if($prescription AND $tmpSkuCount == $tmpPrescriptionCount){
            $request['order_type'] = 'rx-only';
        }else if($prescription AND $tmpSkuCount != $tmpPrescriptionCount){
