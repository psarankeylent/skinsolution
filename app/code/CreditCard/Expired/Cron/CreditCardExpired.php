...
namespace CreditCard\Expired\Cron;

use Magento\Framework\App\Config\ScopeConfigInterface;
use Magento\Store\Model\ScopeInterface;

class CreditCardExpired
{
    ...
    public function execute()
    {
        ...
        //$writer = new \Zend\Log\Writer\Stream(BP . '/var/log/creditcard_expired.log');
