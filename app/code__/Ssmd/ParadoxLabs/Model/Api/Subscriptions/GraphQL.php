...
namespace Ssmd\ParadoxLabs\Model\Api\Subscriptions;
 ...
 * GraphQL Class
 */
class GraphQL extends \ParadoxLabs\Subscriptions\Model\Api\GraphQL
{
    /**
    ...
    )
    {
        ...
        foreach ($quote->getAllItems() as $item) {
            $quoteArr = $item->toArray();
            $quoteArr['product'] = $item->getProduct()->getData();
            $quoteArr['product']['model'] = $item->getProduct();
            $quoteData['items'][] = $quoteArr;
        }
