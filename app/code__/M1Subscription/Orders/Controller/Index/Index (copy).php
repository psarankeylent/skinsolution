...
namespace M1Subscription\Orders\Controller\Index;
...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $collection->addFieldToFilter("reference_id", array('eq' => '48055621'))
                   //->addFieldToFilter('created_at', array('from' => $fromDate, 'to' => $toDate))
                   ->setOrder('created_at','DESC');
...
exit;
        ...
        try{
            ...
            if(!empty($data))
            {
                $newData['profile_id']      = $collection->getData('reference_id');
