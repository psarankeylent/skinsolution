...
/**
 * Class TicketByExternalResolver
 *
 * @package Aheadworks\Helpdesk2GraphQl\Model\Resolver
 */
class TicketByExternalResolver extends AbstractResolver
{
    /**
    ...
    protected function performResolve(
        ...
        $ticket = $this->repository->getByExternalLink($args['external_link']);
    ...
    {
        if (isset($args['external_link']) && $args['external_link'] < 1) {
            throw new GraphQlInputException(__('Specify the "external_link" value.'));
        }
    }
}
