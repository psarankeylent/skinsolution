...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Backend_CatalogTracking' => 1,
        'Backend_CustomerMedical' => 1,
        'Backend_CustomerPhotos' => 1,
        'Backend_InlineEdit' => 1,
        'Backend_Medical' => 1,
        'Backend_MedicalGraphql' => 1,
        'Backend_OrderMedical' => 1,
        'Backend_PauseSubscription' => 1,
        'Backend_SyncMedical' => 1,
        'Backend_SyncPhotos' => 1,
        'Backend_UpdateSubscriptionPrice' => 1,
        'ConsultOnly_ConsultOnlyCollection' => 1,
        'ConsultOnly_ConsultOnlyGraphql' => 1,
        'ConsultOnly_ConsultOnlyTab' => 1,
        'ConsultOnly_UpdateConsultOnly' => 1,
        'CreditCard_CronSchedule' => 1,
        'CreditCard_Expired' => 1,
        'CreditCard_Expiring' => 1,
        'CustomOrders_GenerateOrders' => 1,
        'CustomReports_AuthUnsettledTransList' => 1,
        'CustomReports_BatchListReport' => 1,
        'CustomReports_CatalogTrackingReport' => 1,
        'CustomReports_DownloadReports' => 1,
        'CustomReports_ImpersonationReport' => 1,
        'CustomReports_ReconciliationInvoiceReport' => 1,
        'CustomReports_StoreCreditUsage' => 1,
        'Demo_Chk' => 1,
        ...
        'Klarna_Kp' => 1,
        'Lof_GiftSalesRule' => 1,
        'M1Subscription_CustomOrder' => 1,
        'M1Subscription_M1SubscriptionCollection' => 1,
        'M1Subscription_M1SubscriptionGraphql' => 1,
        'MH_Tables' => 1,
        ...
        'Prescriptions_Attributes' => 1,
        'Prescriptions_Expiring' => 1,
        'Prescriptions_PrescriptionsCollection' => 1,
        'Prescriptions_PrescriptionsGraphql' => 1,
        'Prescriptions_PrescriptionsTable' => 1,
        'Prescriptions_UpdatePrescriptions' => 1,
        'Renewal_CcReports' => 1,
        'Renewal_DeclinedSubscriptionsReport' => 1,
        'Renewal_DeclinedSubscriptionsReportM1' => 1,
        'Renewal_ExpirationReport' => 1,
        'Renewal_OrderItemReport' => 1,
        'Renewal_OrderReport' => 1,
        'Renewal_StoreCreditReport' => 1,
        'Renewal_SubscriptionReport' => 1,
        'Sms_Custom' => 0,
        'Ssmd_AlleCustom' => 1,
        'Ssmd_Catalog' => 1,
        'Ssmd_Customer' => 1,
        'Ssmd_CustomerNotes' => 1,
        'Ssmd_CustomerPhotos' => 1,
        'Ssmd_CustomerResetPassword' => 1,
        'Ssmd_Faqs' => 1,
        'Ssmd_FreeGift' => 1,
        'Ssmd_GraphqlChanges' => 1,
        'Ssmd_Impersonation' => 1,
        'Ssmd_MedicalHistory' => 1,
        'Ssmd_MultipleCoupons' => 1,
        'Ssmd_OfflineShipping' => 1,
        'Ssmd_ParadoxLabs' => 1,
        'Ssmd_ProductAdditionalContent' => 1,
        'Ssmd_ProductFaqs' => 1,
        'Ssmd_ProductTopContent' => 1,
        'Ssmd_Quote' => 1,
        'Ssmd_Sales' => 1,
        'Ssmd_SalesNotes' => 1,
        'Ssmd_StoreCredit' => 1,
        'Ssmd_SubscriptionLable' => 1,
        'Ssmd_Subscriptions' => 1,
        'Ssmd_ZeroDollarOrders' => 1,
        'Temando_ShippingRemover' => 1,
        'Vertex_Tax' => 1,
        'Vertex_AddressValidationApi' => 1,
        'Vertex_AddressValidation' => 1,
        'VirtualHub_Config' => 1,
        'VirtualHub_CustomOrder' => 1,
        'VirtualHub_MedicalPhoto' => 1,
        'VirtualHub_Medicalinfo' => 1,
        'VirtualHub_MhByCustomerId' => 1,
        'VirtualHub_OrderCancellation' => 1,
        'VirtualHub_OrderPush' => 1,
        'VirtualHub_PaymentCapture' => 1,
        'VirtualHub_PhotoByCustomerId' => 1,
        'VirtualHub_UpdateAddress' => 1,
        'VirtualHub_UpdateContact' => 1,
        'VirtualHub_UpdateDateOfBirth' => 1,
        'VirtualHub_UpdatePhoto' => 1,
        'VirtualHub_UpdatePrescriptionOrder' => 1,
        'VirtualHub_VhOrderLog' => 1,
        'Yotpo_Yotpo' => 1
    ]
];
