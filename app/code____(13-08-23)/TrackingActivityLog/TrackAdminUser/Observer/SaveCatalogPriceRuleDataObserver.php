...
class SaveCatalogPriceRuleDataObserver implements ObserverInterface
{
    ...
    public function __construct(        
        \Magento\CatalogRule\Model\RuleFactory $rulesFactory,
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $ruleId = $observer->getRule()->getId();  // you will get catalog rule object        
        ...
        try{
            ...
            $actionLogsModel->setData('entity', 'Catalog Price Rule')
