...
class ExpirationDataProvider extends \Magento\Framework\View\Element\UiComponent\DataProvider\DataProvider
{
        ...
        if(isset($filters))
        {
            ...
            foreach ($filters as $key => $value) {
                ...
                /*if($key == 'firstname')
                {
                    ...
                    $collection->addFieldToFilter(['firstname', 'lastname'],
                        [
                            ['eq' => $value],
                            ['eq' => $value]                        
                        ]);
    ...
    public function addFilter(\Magento\Framework\Api\Filter $filter)
    {
        ...
        $collection = $objectManager->get('\Renewal\ExpirationReport\Model\ResourceModel\ExpirationReport\CollectionFactory')->create();
       ...
       // echo $paramValue; exit;
        ...
        {
            //parent::addFilter(\Magento\Framework\Api\Filter $filter);
        }
