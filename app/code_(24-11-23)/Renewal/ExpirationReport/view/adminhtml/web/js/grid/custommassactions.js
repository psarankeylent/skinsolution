    ...
    return Collapsible.extend({
        ...
        applyAction: function (actionIndex) {
            var data = this.getSelections(),
                ...
                // ================= Custom code added here start =============== 
                if( data.params.namespace == 'renewal_expiration_report_listing' || data.params.namespace == 'reports_cc_listing' )
                {
                    data.total=1;   // By default selected for this event
                    console.log(data.params.namespace);
                }
                // ================= Custom code added here end =================== 
