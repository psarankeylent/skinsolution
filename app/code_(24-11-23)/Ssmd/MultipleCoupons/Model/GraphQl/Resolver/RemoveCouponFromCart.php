...
namespace Ssmd\MultipleCoupons\Model\GraphQl\Resolver;
 ...
 * @inheritdoc
 */
class RemoveCouponFromCart extends \Magento\QuoteGraphQl\Model\Resolver\RemoveCouponFromCart
{
    /**
     * @var GetCartForUser
     */
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        try {
            $this->couponManagement->removeCoupon($cartId, $couponCode);
