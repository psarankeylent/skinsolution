...
class UpdateSubscriptionAddress implements \ParadoxLabs\TokenBase\Model\Api\GraphQL\ResolverInterface
{
    ...
    protected function validateInput(array $args)
    {
        ...
        $requiredFields = ['entity_id', 'address', 'region','address_type'];
    ...
    public function updateShippingAddress(
        ...
        if ((bool)$quote->getIsVirtual() === false) {
            ...
            if (isset($args['input']['region'])) {
                $addressData['region'] = $args['input']['region'];
            }
            //print_r($addressData); exit;
            
            $region = $this->getRegionDetails($addressData['region']);
    ...
    // Get Region details aray by Region
    public function getRegionDetails($region)
    {
